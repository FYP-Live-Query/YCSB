...
public class JdbcDBClientTest {
  private static final String TEST_DB_DRIVER = "com.mysql.jdbc.Driver";
  private static final String TEST_DB_URL = "jdbc:mysql://root:debezium@10.8.100.246:3306/inventory";
  private static final String TEST_DB_USER = "admin";
  private static final String TEST_DB_PASSWD = "admin";
  ...
  public static void setupWithBatch(int batchSize, boolean autoCommit) {
    try {
      ...
      p.setProperty(JdbcDBClient.CONNECTION_PASSWD, TEST_DB_PASSWD);
